...
Будь ласка, оберіть локацію, де ви скуштували нашу каву:
"""
...
Будь ласка, оцініть нашу каву від 1 до 5 зірок:
"""
...
Тепер, якщо бажаєте, напишіть більш детальний відгук про каву або обслуговування.
...
Завжди раді бачити вас у наших кав'ярнях! ☕❤️
...
def main() -> None:
    ...
    # Отримуємо порт з змінних середовища (для Render)
    port = int(os.environ.get('PORT', 8000))
    
    # Запускаємо бота
    print(f"Бот запущено на порту {port}! Натисніть Ctrl+C для зупинки.")
